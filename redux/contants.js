...
export const MENU_CHANGE_IS_SELECTED =
  "MENU_CHANGE_IS_SELECTED";
/* TODOAPP */
...
/* DASHBOARD */
export const CHANGE_DASHBOARD_DATA = "CHANGE_DASHBOARD_DATA";
export const CHANGE_REVIEWS_DATA = "CHANGE_REVIEWS_DATA";
